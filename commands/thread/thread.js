...
module.exports = {
    ...
    async run(client, message, args){
        ...
        if (args[0] === 'join') {
            ...
            if (!args[1]) return message.reply('Merci de spécifié un ID de channel !');
    ...
    async runInteraction(client, interaction) {
        ...
        if ((thread.type != 'GUILD_PUBLIC_TREAD') || (thread.type != 'GUILD_PRIVATE_TREAD')) return interaction.reply('Impossible de taper cette commande car vous n\'etes pas dans un thread');
