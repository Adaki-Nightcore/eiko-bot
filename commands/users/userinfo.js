...
module.exports = {
    ...
    async runInteraction(client, interaction) {
        ...
        .addFields(
            ...
            { name: 'Modératuer', value: `${member.kickable ? '🔴' : '🟢'}`, inline: true },
            ...
            { name: 'A rejoindt le serveur le', value: `<t:${parseInt(member.joinedTimestamp / 1000)}:f> (<t:${parseInt(member.joinedTimestamp / 1000)}:R>)` },
        )
